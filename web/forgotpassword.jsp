 ...
 <div class="wrapper">
      ...
      <div class="form-container">
        <div class="slide-controls">
          ...
          <label for="login" class="slide login">Quên mật khẩu</label>
          <div class="slider-tab"></div>
        </div>
        <c:if test="${sessionScope.reset == null}">
          ...
          <form action="ForgotPasswordControl" class="login" method="POST">
            <div class="field">
              ...
              <input type="submit" value="Gửi mã">
                 ...
                 <div class="house">    
              <div class="house"><a href="login.jsp">Quay lại đăng nhập</a></div>
...
<!--            session code-->
    <c:if test="${sessionScope.reset != null}">
        <script>
            alert("Mã xác nhận đã gửi về số điện thoại");
        </script>
             <div class="form-inner">
          <form action="#" class="login" method="POST" name="OTP">
            <div class="field">
              <input type="text" name="phone" placeholder="Nhập mã xác nhận" required>
               <div class="field btn">
              <div class="btn-layer"></div>
