 ...
 <div class="wrapper">
      ...
      <div class="form-container">
        <div class="slide-controls">
          ...
          <label for="login" class="slide login">Vui lòng điền mã xác nhận</label>
          <div class="slider-tab"></div>
        </div>
             <div class="form-inner">
          <form action="VerifyCode" class="login" method="POST" name="OTP">
            <div class="field">
              <input type="text" name="authcode" placeholder="Nhập mã xác nhận" required>
               <div class="field btn">
